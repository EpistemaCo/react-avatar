...
class Avatar extends React.Component {
  ...
  init() {
    ...
    if (originalWidth > originalHeight) {
      //if (originalWidth < imageWidth) {
        imgHeight *= imageWidth / originalWidth;
        imgWidth = imageWidth;
      //}
    } else {
      //if (originalHeight < imageHeight) {
        imgWidth *= imageHeight / originalHeight;
        imgHeight = imageHeight;
      //}
    }

    const scale = imgHeight / originalHeight;
    const cropRadius = Math.min(imgWidth, imgHeight) / 3;
